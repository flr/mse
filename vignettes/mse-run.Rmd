...
source('~/Desktop/flr/FLRP/R/mseMPB.R')
...
set.seed(3452)
oms[["Grey Box"]]=
  mseMPB(window(oms[["Perfect"]],start=20,end=103),eql,mp,srDev=srDev,uDev=uDev,start=75,end=100)
save(oms, file="/home/laurie/Desktop/flr/FLRP/data/oms.RData")
```
...
oms[["Grey Box Noise in M"]]=
  mseMPB(window(oms[["Perfect Noise in M"]],start=20,end=103),eql,mp,srDev=srDev,uDev=uDev,start=75,end=100)
save(oms, file="/home/laurie/Desktop/flr/FLRP/data/oms.RData")
```
...
oms[["Grey Box Red Noise in M"]]=
  mseMPB(window(oms[["Perfect Red Noise in M"]],start=20,end=103),eql,mp,srDev=srDev,uDev=uDev,start=75,end=100)
save(oms, file="/home/laurie/Desktop/flr/FLRP/data/oms.RData")
```
...
dat=transform(ldply(oms,function(x) as.data.frame(window(ssb(x),start=75,end=100),drop=TRUE)),
...
dat=transform(ldply(oms,function(x) as.data.frame(window(fbar(x),start=75,end=100),drop=TRUE)),
    Scenario=factor(.id,levels=c("White Box","White Box Noise in M","White Box Red Noise in M",
                                 "Grey Box","Grey Box Noise in M","Grey Box Red Noise in M",
                                 "Black Box","Black Box Noise in M","Black Box Red Noise in M",
                                 "Perfect","Perfect Noise in M","Perfect Red Noise in M")))
...
dat=transform(ldply(oms,function(x) as.data.frame(window(catch(x),start=75,end=100),drop=TRUE)),
    Scenario=factor(.id,levels=c("White Box","White Box Noise in M","White Box Red Noise in M",
                                 "Grey Box","Grey Box Noise in M","Grey Box Red Noise in M",
                                 "Black Box","Black Box Noise in M","Black Box Red Noise in M",
                                 "Perfect","Perfect Noise in M","Perfect Red Noise in M")))
