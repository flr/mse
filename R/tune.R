...
tunegrid <- function(om, oem="missing", control, statistic, matrics=NULL, args,
  grid, years=ac(seq(args$iy + 1, args$fy)), parallel=FALSE, verbose=FALSE, 
  iters=dims(om)$iter, ...) {
...
#' @param sr The stock-recruits relationship to use in fwd.
#' @param SBlim
#' @param range
#' @param nyears
#' @param sigmaR
