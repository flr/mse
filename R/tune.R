...
#' SSB[MSY] over the 2032 to 2042 period.
#'
...
#' }
#'
#' @param om An object representing the Operating Model, of class \linkS4class{FLom} or \linkS4class{FLombf}.
#' @param oem Observation Error Model, class \linkS4class{FLoem} or missing, the default.
#' @param control A control object containing the settings and parameters for the Management Procedure, class  \linkS4class{mpCtrl}.
...
#'   }
#' @param metrics Optional. A set of metrics used for performance evaluation; defaults to `NULL` to use the default metrics for the class of the `om` object.
...
tunebisect <- function(om, oem=NULL, control, statistic, metrics=NULL, args,
  ...
  if(length(statistic) != 1 | is.null(statistic[[1]])) {
